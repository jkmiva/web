...
(function() {
   ...
   var photo1 = {pid: 1, date_time: "2012-08-30 10:44:23", file_name: "ouster.jpg", user: jo};
   var photo2 = {pid: 2, date_time: "2009-09-13 20:00:00", file_name: "malcolm2.jpg", user: im};
   var photo3 = {pid: 3, date_time: "2009-09-13 20:05:03", file_name: "malcolm1.jpg", user: im};
   var photo4 = {pid: 4, date_time: "2013-11-18 18:02:00", file_name: "ripley1.jpg", user: er};
   var photo5 = {pid: 5, date_time: "2013-09-20 17:30:00", file_name: "ripley2.jpg", user: er};
   var photo6 = {pid: 6, date_time: "2009-07-10 16:02:49", file_name: "kenobi1.jpg", user: rk};
   var photo7 = {pid: 7, date_time: "2010-03-18 23:48:00", file_name: "kenobi2.jpg", user: rk};
   var photo8 = {pid: 8, date_time: "2010-08-30 14:26:00", file_name: "kenobi3.jpg", user: rk};
   var photo9 = {pid: 9, date_time: "2013-12-03 09:02:00", file_name: "took1.jpg", user: pt};
   var photo10 = {pid: 10, date_time: "2013-12-03 09:03:00", file_name: "took2.jpg", user: pt};
   var photo11 = {pid: 11, date_time: "2013-09-04 09:16:32", file_name: "ludgate1.jpg", user: al};
   var photo12 = {pid: 12, date_time: "2008-10-16 17:12:28", file_name: "kenobi4.jpg", user: rk};
   ...
   var comment1 = {
      ...
      "it's so easy to forget a </div>!", user: jo, photo_id: photo1.pid
   };
   ...
   var comment2 = {
      ...
      "from line to line?", user: jo, photo_id: photo1.pid
   };
   ...
   var comment3 = {
      ...
      "then HTML escaping isn't working properly.", user: jo, photo_id: photo1.pid
   };
   ...
   var comment4 = {
      ...
      "there it is. Life finds a way.", user: im, photo_id: photo2.pid
   };
   ...
   var comment5 = {
      ...
      "away?", user: er, photo_id: photo5.pid
   };
   ...
   var comment6 = {
      ...
      "you do with the scavenged tech, got any tips?", user: er, photo_id: photo7.pid
   };
   ...
   var comment7 = {
      ...
      "the moment, but let's meet up when I get back! :)", user: rk, photo_id: photo7.pid
   };
   ...
   var comment8 = {
      ...
      "home, anyway.", user: rk, photo_id: photo8.pid
   };
   ...
   var comment9 = {
      ...
      "speeds that'll rival any First Order piece of junk.", user: rk, photo_id: photo12.pid
   };
   ...
   var comment10 = {
      ...
      "breakfast?", user: pt, photo_id: photo10.pid
   };
   ...
   var comment11 = {
      ...
      "occasionally chooses to cooperate. ", user: al, photo_id: photo11.pid
   };
   
   var comment12 = {
      id: 12,
      date_time: "2016-01-04 2:00:01",
      comment: "Which one are you?", user: al, photo_id: photo9.pid
   };
   
   var comment13 = {
      id: 13,
      date_time: "2016-01-04 2:04:01",
      comment: "The tall one.", user: pt, photo_id: photo9.pid
   };
